...
class TrainView(View):
    def get(self, request):
        ...
        self.answer10 = Entry.objects.annotate(number_of_entries=Count('author_id')).values('author_id', 'number_of_entries')
